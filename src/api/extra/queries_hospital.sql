...
from pacientes p
where
	p.nome = 'Brittany Dawson' or
	p.cpf = '973463459806' or
	p.cartao_sus  = '730671487762879143';
...
on e.id = a.doctor_id 
where
	p.name = 'Spencer Holland' or
	p.cpf = '662298809331' or
	p.sus_card = '125372107773295451';

/* ----------- Update Patient info ----------------------*/
update patients 
set 
	cpf = '11111111111',
	birthdate = '2666-06-06',
	phone = '66666666666',
	sus_card = '55555555555555555'
where name = 'Jason Cobb';
